...
typedef struct  
{
	volatile uint32 DCAM_CFG;				//[31:10]: RESERVED
											//[9]: CMD_ENDIAN_CTRL, CMD queue endian  control
											//		1'b0: {B3,B2,B1,B0};
											//		1'b1: {B0,B1,B2,B3};

											//8]: AUTO_CMD_EXE, Auto command queue execution mode, active high, only for video decoding
	...
	volatile uint32 DCAM_INT_STS;	
											//[31:16]: RESERVED
											//[15]: VSP_CMD_DONE, Command execution done interrupt
											...
											//[10]: VSP_CMD_TIME_OUT, Time out during command execution mode
