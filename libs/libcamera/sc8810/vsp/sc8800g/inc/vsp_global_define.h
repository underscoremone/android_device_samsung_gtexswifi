...
#define	VSP_MEMO9_ADDR				(VSP_DCAM_REG_BASE + 0xb000)
...
#define MEMO9_ADDR_SIZE				(1024*4)
#define MEMO10_ADDR_SIZE			(1024*4)

//COMMON
#define HUFFMAN_TBL_ADDR			VSP_MEMO5_ADDR	
...
#define MP4DEC_MCA_FW_BFR_ADDR		VSP_MEMO1_ADDR
#define MP4DEC_MCA_BW_BFR_ADDR		VSP_MEMO2_ADDR
