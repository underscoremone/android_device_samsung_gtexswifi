...
typedef struct  
{
	...
	volatile uint32 MCA_BLK_CBUF;		//[27]: REF_BLK_END, The following MV command is for the last block of this MB
	...
	volatile uint32 MCA_DEBUG;			//[9]: MV cmd buffer full
