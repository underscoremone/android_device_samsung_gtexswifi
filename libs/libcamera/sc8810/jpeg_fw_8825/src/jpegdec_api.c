									...
									JPEG_DEC_INPUT_PARA_T *dec_fw_info_ptr)
{
	...
	dec_fw_info_ptr->pingpong_buf_0_ptr = (uint8_t *)jpegdec_params->stream_phy_buf[0];
...
/*	if(0 == jpegdec_params->set_slice_height)
	...
	{
		dec_fw_info_ptr->yuv_0_addr.y_data_ptr = (uint8_t*)jpegdec_params->yuv_phy_buf;
		dec_fw_info_ptr->yuv_0_addr.u_data_ptr = (uint8_t*)jpegdec_params->target_phy_buf_UV;
		dec_fw_info_ptr->yuv_0_addr.v_data_ptr = NULL;
