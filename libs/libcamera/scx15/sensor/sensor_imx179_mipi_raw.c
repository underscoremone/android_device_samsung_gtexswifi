...
LOCAL uint32_t _imx179_GetResolutionTrimTab(uint32_t param);
LOCAL uint32_t _imx179_PowerOn(uint32_t power_on);
LOCAL uint32_t _imx179_Identify(uint32_t param);
LOCAL uint32_t _imx179_BeforeSnapshot(uint32_t param);
LOCAL uint32_t _imx179_after_snapshot(uint32_t param);
LOCAL uint32_t _imx179_StreamOn(uint32_t param);
LOCAL uint32_t _imx179_StreamOff(uint32_t param);
LOCAL uint32_t _imx179_write_exposure(uint32_t param);
LOCAL uint32_t _imx179_write_gain(uint32_t param);
LOCAL uint32_t _imx179_write_af(uint32_t param);
LOCAL uint32_t _imx179_flash(uint32_t param);
LOCAL uint32_t _imx179_ExtFunc(uint32_t ctl_param);
LOCAL int _imx179_get_VTS(void);
LOCAL int _imx179_set_VTS(int VTS);
LOCAL uint32_t _imx179_ReadGain(uint16_t *data);
LOCAL uint32_t _imx179_set_video_mode(uint32_t param);
...
LOCAL uint32_t _imx179_GetResolutionTrimTab(uint32_t param)
{
	SENSOR_PRINT("0x%x",  (uint32_t)s_imx179_Resolution_Trim_Tab);
	return (uint32_t) s_imx179_Resolution_Trim_Tab;
}
LOCAL uint32_t _imx179_PowerOn(uint32_t power_on)
{
	...
	SENSOR_PRINT("SENSOR_IMX179: _imx179_Power_On(1:on, 0:off): %d, reset_level %d, dvdd_val %d", power_on, reset_level, dvdd_val);
	return SENSOR_SUCCESS;
}

LOCAL uint32_t _imx179_cfg_otp(uint32_t  param)
{
...
LOCAL uint32_t _imx179_GetMaxFrameLine(uint32_t index)
{
...
LOCAL uint32_t _imx179_after_snapshot(uint32_t param)
{
	SENSOR_PRINT("SENSOR_imx179: after_snapshot mode:%d", param);
	Sensor_SetMode(param);
	return SENSOR_SUCCESS;
}
...
static uint32_t _imx179_SetEV(uint32_t param)
{
	uint32_t rtn = SENSOR_SUCCESS;
