...
LOCAL uint32_t _ov13850_Identify(uint32_t param);
LOCAL uint32_t _ov13850_BeforeSnapshot(uint32_t param);
LOCAL uint32_t _ov13850_after_snapshot(uint32_t param);
LOCAL uint32_t _ov13850_StreamOn(uint32_t param);
LOCAL uint32_t _ov13850_StreamOff(uint32_t param);
LOCAL uint32_t _ov13850_write_exposure(uint32_t param);
LOCAL uint32_t _ov13850_write_gain(uint32_t param);
LOCAL uint32_t _ov13850_write_af(uint32_t param);
LOCAL uint32_t _ov13850_flash(uint32_t param);
LOCAL uint32_t _ov13850_ExtFunc(uint32_t ctl_param);
LOCAL uint32_t _dw9174_SRCInit(uint32_t mode);
LOCAL uint32_t _ov13850_get_VTS(void);
LOCAL uint32_t _ov13850_set_VTS(int VTS);
LOCAL uint32_t _ov13850_ReadGain(uint32_t param);
...
LOCAL uint32_t _ov13850_PowerOn(uint32_t power_on)
{
	...
	SENSOR_PRINT("SENSOR_ov13850: _ov13850_Power_On(1:on, 0:off): %d", power_on);
...
LOCAL uint32_t _ov13850_GetMaxFrameLine(uint32_t index)
{
...
LOCAL uint32_t  OV13850_set_shutter(uint32_t shutter)
{
...
LOCAL uint32_t OV13850_set_VTS(uint32_t VTS)
{
...
LOCAL uint32_t _ov13850_after_snapshot(uint32_t param)
{
	SENSOR_PRINT("SENSOR_ov13850: after_snapshot mode:%d", param);
...
static uint32_t _ov13850_SetEV(uint32_t param)
{
	uint32_t rtn = SENSOR_SUCCESS;
