...
LOCAL uint32_t _sr352_set_anti_flicker(uint32_t mode);
LOCAL uint32_t _sr352_set_video_mode(uint32_t mode);
...
LOCAL uint32_t _sr352_StreamOn(uint32_t param);
...
LOCAL uint32_t _sr352_set_brightness(uint32_t level)
{
	...
	SENSOR_PRINT("SENSOR: _sr352_set_brightness = 0x%02x.\n",level);
	return 0;
}
...
#endif
	SENSOR_PRINT("SENSOR: _sr352_set_awb = 0x%02x\n", mode);
	return 0;
}
...
LOCAL uint32_t _sr352_set_work_mode(uint32_t mode)
{
	...
	SENSOR_PRINT("SENSOR: _sr352_set_work_mode: mode = %d \n", mode);
	return 0;
}
...
LOCAL uint32_t _sr352_BeforeSnapshot(uint32_t param)
{
	...
	SENSOR_PRINT("SENSOR: _sr352_BeforeSnapshot = %d \n", param);
