...
static uint32_t Sr030pc50_GetResolutionTrimTab(uint32_t param);
static uint32_t Sr030pc50_PowerOn(uint32_t power_on);
static uint32_t Sr030pc50_Identify(uint32_t param);
static uint32_t Sr030pc50_StreamOn(uint32_t param);
static uint32_t Sr030pc50_StreamOff(uint32_t param);
static uint32_t Sr030pc50_Set_Brightness(uint32_t level);
static uint32_t Sr030pc50_Set_Saturation(uint32_t level);
static uint32_t Sr030pc50_Set_Image_Effect(uint32_t effect_type);
static uint32_t Sr030pc50_Set_Anti_Flicker(uint32_t mode);
static uint32_t Sr030pc50_Set_Video_Mode(uint32_t mode);
static uint32_t Sr030pc50_Set_Awb(uint32_t mode);
static uint32_t Sr030pc50_Set_Work_Mode(uint32_t mode);
static uint32_t Sr030pc50_BeforeSnapshot(uint32_t param);
static uint32_t Sr030pc50_AfterSnapshot(uint32_t param);
...
static uint32_t Sr030pc50_GetExifInfo(uint32_t param)
{
	return (uint32_t)&s_Sr030pc50_Exif;
}

static uint32_t Sr030pc50_GetResolutionTrimTab(uint32_t param)
{
	return (uint32_t) s_Sr030pc50_Resolution_Trim_Tab;
}

static uint32_t Sr030pc50_SetExifInfo_Exposure(uint32_t param)
{
...
static uint32_t Sr030pc50_SetExifInfo_ISO(uint32_t param)
{
	EXIF_SPEC_PIC_TAKING_COND_T *sensor_exif_info_ptr = &s_Sr030pc50_Exif;
	uint8_t iso       = 0;
...
static uint32_t Sr030pc50_Set_Brightness(uint32_t level)
{
	...
	SENSOR_PRINT("sensor: Sr030pc50_Set_Brightness = %d", level);
...
static uint32_t Sr030pc50_Set_Saturation(uint32_t level)
{
	...
	SENSOR_PRINT("sensor: Sr030pc50_Set_Saturation = %d", level);
...
static uint32_t Sr030pc50_Set_Image_Effect(uint32_t effect_type)
{
	...
	SENSOR_PRINT("sensor: Sr030pc50_Set_Image_Effect = %d", effect_type);
...
static uint32_t Sr030pc50_Set_Anti_Flicker(uint32_t mode)
{
	...
	SENSOR_PRINT("sensor: Sr030pc50_Set_Anti_Flicker= %d", mode);
...
static uint32_t Sr030pc50_Set_Video_Mode(uint32_t mode)
{
	...
	SENSOR_PRINT("sensor:  Sr030pc50_Set_Video_Mode = %d", mode);
...
static uint32_t Sr030pc50_Set_Awb(uint32_t mode)
{
	...
	SENSOR_PRINT("sensor: Sr030pc50_Set_Awb = %d", mode);
...
LOCAL uint32_t Sr030pc50_Set_Work_Mode(uint32_t mode)
{
	uint16_t i = 0x00;
	...
	CMR_LOGI("sensor: Sr030pc50_Set_Work_Mode = %d", mode);
...
static uint32_t Sr030pc50_AfterSnapshot(uint32_t param)
{
	...
	SENSOR_PRINT("Sr030pc50_AfterSnapshot =%d", param);
