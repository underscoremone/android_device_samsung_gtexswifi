...
int isp_app_msg_queue_create(uint32_t count, uint32_t *queue_handle);

int isp_app_msg_get(uint32_t queue_handle, struct isp_app_msg *message);

int isp_app_msg_post(uint32_t queue_handle, struct isp_app_msg *message);

int isp_app_msg_flush(uint32_t queue_handle, struct isp_app_msg *message);

int isp_app_msg_queue_destroy(uint32_t queue_handle);
