...
LOCAL_C_INCLUDES    +=  device/samsung/gtexslte/libs/libatchannel/
LOCAL_C_INCLUDES    +=  device/samsung/gtexslte/libs/gnsspc/
LOCAL_C_INCLUDES    +=  $(TARGET_OUT_INTERMEDIATES)/KERNEL/source/include/uapi/mtd/
LOCAL_C_INCLUDES += device/samsung/gtexslte/libs/libbm/
...
LOCAL_C_INCLUDES    +=  device/samsung/gtexslte/libs/engmode/bt/
### bt bqb
